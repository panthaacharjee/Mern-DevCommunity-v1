...
router.route("/reply/add/:id").post(isAuthenticatedUser, addReply);
router
  .route("/reply/likeAndunlike/:id")
  .post(isAuthenticatedUser, likeAndunlikeReply);

router.route("/reply/delete/:id").delete(isAuthenticatedUser, deleteReply);
